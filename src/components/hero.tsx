    ...
    <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-4 max-w-7xl mx-auto w-full gap-12 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-white mb-8 leading-[1.2] md:leading-[1.15]">
            <motion.span
              initial={{ opacity: 0, y: 50, rotate: 2 }}
              animate={{ opacity: 1, y: 0, rotate: 0 }}
              transition={{ duration: 0.8, ease: "easeOut", delay: 0.1 }}
              className="block text-[24px] bg-gradient-to-br from-white via-white to-gray-500 bg-clip-text text-transparent mb-4 md:mb-6"
            >
            ...
            <motion.span
              ...
              className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-600"
            >
